...
namespace ourChat
{
    partial class mainWindow
    {
        ...
        /// </summary>
        static string[] error_code = new string[] { "error not connected", "error invalide input", "error exception", "error exceed time limited", "error not online or not reachable" };
